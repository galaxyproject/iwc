    ...
    >
        ...
        <CardContent :class="['flex-1 flex flex-col', compact ? 'px-3 py-2' : 'px-6 py-2']">
            <div class="flex flex-col flex-grow">
                ...
                <div v-if="workflow.collections && workflow.collections.length > 0 && !compact" class="flex flex-wrap gap-2">
                    <Badge
                ...
                <div v-else-if="workflow.collections && workflow.collections.length > 0 && compact" class="flex flex-wrap gap-1">
                    <Badge
