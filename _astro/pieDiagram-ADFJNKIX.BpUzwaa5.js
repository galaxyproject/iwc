import{ac as y,a4 as M,aH as U,g as j,s as q,a as Y,b as Z,q as J,p as K,_ as u,l as _,c as Q,D as X,H as ee,O as te,e as ae,y as re,E as ne}from"./MarkdownRenderer.DMtASQ2u.js";import{p as ie}from"./chunk-4BX2VUAB.BLJiYJci.js";import{p as se}from"./treemap-GDKQZRPO.XwFuXS-0.js";import{d as W}from"./arc.DKLiKPSL.js";import{o as oe}from"./ordinal.CVPaYpc-.js";/* empty css                        */import"./_plugin-vue_export-helper.BwK_ctKS.js";import"./runtime-core.esm-bundler.TB6CtJyN.js";import"./_baseUniq.DpYTFMSl.js";import"./_basePickBy.kIj6K8Le.js";import"./clone.CnlWezx8.js";import"./init.D0X85uHN.js";(function(){try{var e=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{};e.SENTRY_RELEASE={id:"70f24837bbf6ed68283462750bbe552d5e485cf7"};var a=new e.Error().stack;a&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[a]="c02a2e3b-fdba-4da8-8659-2ace22fa42a2",e._sentryDebugIdIdentifier="sentry-dbid-c02a2e3b-fdba-4da8-8659-2ace22fa42a2")}catch{}})();function le(e,a){return a<e?-1:a>e?1:a>=e?0:NaN}function ce(e){return e}function de(){var e=ce,a=le,g=null,S=y(0),s=y(M),l=y(0);function o(t){var n,c=(t=U(t)).length,p,w,h=0,d=new Array(c),i=new Array(c),v=+S.apply(this,arguments),x=Math.min(M,Math.max(-M,s.apply(this,arguments)-v)),m,A=Math.min(Math.abs(x)/c,l.apply(this,arguments)),C=A*(x<0?-1:1),f;for(n=0;n<c;++n)(f=i[d[n]=n]=+e(t[n],n,t))>0&&(h+=f);for(a!=null?d.sort(function(D,b){return a(i[D],i[b])}):g!=null&&d.sort(function(D,b){return g(t[D],t[b])}),n=0,w=h?(x-c*C)/h:0;n<c;++n,v=m)p=d[n],f=i[p],m=v+(f>0?f*w:0)+C,i[p]={data:t[p],index:n,value:f,startAngle:v,endAngle:m,padAngle:A};return i}return o.value=function(t){return arguments.length?(e=typeof t=="function"?t:y(+t),o):e},o.sortValues=function(t){return arguments.length?(a=t,g=null,o):a},o.sort=function(t){return arguments.length?(g=t,a=null,o):g},o.startAngle=function(t){return arguments.length?(S=typeof t=="function"?t:y(+t),o):S},o.endAngle=function(t){return arguments.length?(s=typeof t=="function"?t:y(+t),o):s},o.padAngle=function(t){return arguments.length?(l=typeof t=="function"?t:y(+t),o):l},o}var ue=ne.pie,z={sections:new Map,showData:!1},T=z.sections,F=z.showData,pe=structuredClone(ue),fe=u(()=>structuredClone(pe),"getConfig"),ge=u(()=>{T=new Map,F=z.showData,re()},"clear"),me=u(({label:e,value:a})=>{if(a<0)throw new Error(`"${e}" has invalid value: ${a}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);T.has(e)||(T.set(e,a),_.debug(`added new section: ${e}, with value: ${a}`))},"addSection"),he=u(()=>T,"getSections"),ve=u(e=>{F=e},"setShowData"),ye=u(()=>F,"getShowData"),L={getConfig:fe,clear:ge,setDiagramTitle:K,getDiagramTitle:J,setAccTitle:Z,getAccTitle:Y,setAccDescription:q,getAccDescription:j,addSection:me,getSections:he,setShowData:ve,getShowData:ye},Se=u((e,a)=>{ie(e,a),a.setShowData(e.showData),e.sections.map(a.addSection)},"populateDb"),we={parse:u(async e=>{const a=await se("pie",e);_.debug(a),Se(a,L)},"parse")},xe=u(e=>`
  .pieCircle{
