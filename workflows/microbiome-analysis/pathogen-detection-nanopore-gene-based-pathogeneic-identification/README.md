...
As outputs, we will get our FASTA and Tabular files to track genes and visualise our pathogenic identification through out all samples in **All samples analysis** workflow.
