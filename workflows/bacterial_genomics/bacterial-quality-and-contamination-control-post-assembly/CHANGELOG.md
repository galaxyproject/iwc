...
- `toolshed.g2.bx.psu.edu/repos/iuc/checkm2/checkm2/1.0.2+galaxy1` was updated to `toolshed.g2.bx.psu.edu/repos/iuc/checkm2/checkm2/1.1.0+galaxy1`
...
* Changed Bracken's mismatch parameter from 10 to 1 because it caused problems for fasta files containing fewer than 10 contigs
