...
- **Reference Taxonomy Database for Kraken2**: identifier of a Kraken2 database (e.g. `k2_minusb_20210517`). Kraken2 classifies each read against this database.
...
- **Reference Taxonomy Database for MetaPhlAn**: identifier of a MetaPhlAn marker database (e.g. `mpa_vJan21_TOY_CHOCOPhlAnSGB_202103-23012026`). The test uses a toy database; for real analyses a full CHOCOPhlAn SGB database should be used.
