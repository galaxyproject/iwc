...
4. **Fasta file with both haplotypes 2** [fasta] - Generated by the pre-curation workflow, containing both haplotypes in a single file
...
- **Assembly informations** - Assembly summary information
